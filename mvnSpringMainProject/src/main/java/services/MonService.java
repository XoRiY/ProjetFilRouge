...
public interface MonService {
	...
	public abstract List<Appareil> getByAppareil(Marque marque, Type type);

	public abstract void deleteAppareil(Appareil appareil);

	public abstract List<Appareil> getAllAppareil();
	...
	public abstract List<Appareil> getAppareilByMarque(Marque marque);

	public abstract List<Appareil> getAppareilByType(Type type);
